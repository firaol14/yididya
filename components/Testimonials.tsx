...
const Testimonials = () => {
  ...
  // Keeping avatar static as it's a resource link, not text
  const avatar = "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=200&auto=format&fit=crop";

  return (
    <section id="testimonials" className="py-12 md:py-24 bg-[#080808] relative overflow-hidden">
            ...
            <div key={i} className="bg-gradient-to-br from-brand-card to-[#0F0F0F] p-6 md:p-12 rounded-3xl border border-brand-border relative shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                  ...
                  <div className="flex-shrink-0 mx-auto md:mx-0 text-center md:text-left w-full md:w-auto flex flex-col items-center md:items-start">
                      <div className="w-16 h-16 md:w-32 md:h-32 rounded-full p-1 bg-gradient-to-br from-brand-green to-transparent mb-3 md:mb-4">
                        <img src={avatar} alt={testimonial.name} className="w-full h-full rounded-full object-cover border-4 border-brand-card" />
                      </div>
                      <h4 className="text-white font-bold text-lg md:text-xl">{testimonial.name}</h4>
                      <div className="flex items-center justify-center md:justify-start gap-1 text-brand-green mt-1">
                          ...
                          <span className="text-xs md:text-sm font-medium">{testimonial.role}</span>
                      </div>
                  </div>
